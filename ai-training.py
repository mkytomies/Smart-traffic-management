...
def connect_to_sumo(sumo_binary="sumo-gui", config_file="./test.sumocfg"):
...
def main():
    connect_to_sumo(config_file="./test.sumocfg")
    ...
    for episode in range(EPISODES):
        ...
        traci.load(["-c", "./test.sumocfg"])  # Reload the simulation for each episode
        state = get_state()
